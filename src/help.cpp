...
std::vector<Page> Help::pages = {
    ...
    Page("Sine","sin","function","Returns the sine of `x`, which is the opposite side divided by hypotenuse of a right triangle with angle `x`. Angles are automatically in radians, see the ?deg? function for degrees.",{"trigonometry"},{},"https://en.wikipedia.org/wiki/Sine_and_cosine"),
    Page("Cosine","cos","function","Returns the cosine of `x`, which is the adjacent side divided by hypotenuse of a right triangle with angle `x`. Angles are automatically in radians, see the ?deg? function for degrees.",{"trigonometry"},{},"https://en.wikipedia.org/wiki/Sine_and_cosine"),
    Page("Tangent","tan","function","Returns the tangent of `x`. Equivalent to `sin(x)/cos(x)` or the opposite side divided by the adjacent side of a right triangle with angle `x`. Angles are automatically in radians, see the ?deg? function for degrees.",{"trigonometry"},{},"https://en.wikipedia.org/wiki/Trigonometric_functions#Right-angled_triangle_definitions"),
    Page("Cosecant","csc","function","Returns the cosecant of `x`. Equivalent to `1/sin(x)` or the hypotenuse divided by the opposite side of a right triangle with angle `x`. Angles are automatically in radians, see the ?deg? function for degrees.",{"trigonometry"},{},"https://en.wikipedia.org/wiki/Trigonometric_functions#Right-angled_triangle_definitions"),
    Page("Secant","sec","function","Returns the secant of `x`. Equivalent to `1/cos(x)` or the hypotenuse divided by the adjacent side of a right triangle with angle `x`. Angles are automatically in radians, see the ?deg? function for degrees.",{"trigonometry"},{},"https://en.wikipedia.org/wiki/Trigonometric_functions#Right-angled_triangle_definitions"),
    Page("Cotangent","cot","function","Returns the cotangent of `x`. Equivalent to `1/tan(x)`, `cos(x)/sin(x)` or the adjacent divided by the opposite side of a right triangle with angle `x`. Angles are automatically in radians, see the ?deg? function for degrees.",{"trigonometry"},{},"https://en.wikipedia.org/wiki/Trigonometric_functions#Right-angled_triangle_definitions"),
    Page("Hyperbolic sine","sinh","function","Returns the hyperbolic sine of `x`. Angles are automatically in radians, see the ?deg? function for degrees.",{"trigonometry"},{},"https://en.wikipedia.org/wiki/Hyperbolic_functions"),
    Page("Hyperbolic cosine","cosh","function","Returns the hyperbolic cosine of `x`. Angles are automatically in radians, see the ?deg? function for degrees.",{"trigonometry"},{},"https://en.wikipedia.org/wiki/Hyperbolic_functions"),
    Page("Hyperbolic tangent","tanh","function","Returns the hyperbolic tangent of `x`. Angles are automatically in radians, see the ?deg? function for degrees.",{"trigonometry"},{},"https://en.wikipedia.org/wiki/Hyperbolic_functions"),
    Page("Inverse sine","asin","function","Returns the inverse ?sine? of `x`. Angles are automatically in radians, see the ?deg? function for degrees.",{"trigonometry","arcsine"},{"asin(sin(x)) = x` for `-pi/2 < x < pi/2"},"https://en.wikipedia.org/wiki/Inverse_trigonometric_functions"),
    Page("Inverse cosine","acos","function","Returns the inverse ?cosine? of `x`. Angles are automatically in radians, see the ?deg? function for degrees.",{"trigonometry","arccosine"},{"acos(cos(x)) = x` for `0 < x < pi"},"https://en.wikipedia.org/wiki/Inverse_trigonometric_functions"),
    Page("Inverse tangent","atan","function","Returns the inverse ?tangent? of `x`. Angles are automatically in radians, see the ?deg? function for degrees.",{"trigonometry","arctan"},{"atan(tan(x)) = x` for `-pi/2 < x < pi/2"},"https://en.wikipedia.org/wiki/Inverse_trigonometric_functions"),
    Page("Arctangent 2","atan2","function","Returns the angle between the point `(y,x)` and `(0,1)`. It is similar to the `arg` function. Angles are automatically in radians, see the ?deg? function for degrees.",{"trigonometry","inverse tangent"},{"atan2(1,0) = pi/2","atan2(i) = pi/2"},"https://en.wikipedia.org/wiki/Atan2"),
    Page("Inverse hyperbolic sine","asinh","function","Returns the inverse ?hyperbolic sine? of `x`. Angles are automatically in radians, see the ?deg? function for degrees.",{"trigonometry","hyperbolic arcsine"},{"asinh(sinh(x)) = x"},"https://en.wikipedia.org/wiki/Inverse_hyperbolic_functions"),
    Page("Inverse hyperbolic cosine","acosh","function","Returns the inverse ?hyperbolic cosine? of `x`. Angles are automatically in radians, see the ?deg? function for degrees.",{"trigonometry","hyperbolic arccosine"},{"acosh(cosh(x)) = x` for `x >= 1"},"https://en.wikipedia.org/wiki/Inverse_hyperbolic_functions"),
    Page("Inverse hyperbolic tangent","atanh","function","Returns the inverse ?hyperbolic tangent? of `x`. Angles are automatically in radians, see the ?deg? function for degrees.",{"trigonometry","hyperbolic arctangent"},{"atanh(tanh(x)) = x"},"https://en.wikipedia.org/wiki/Inverse_hyperbolic_functions"),
    #pragma endregion
    ...
    Page("Degrees","deg","function","Returns degrees converted to radians. There are two ways to use this function: with a number multiplied by deg, or inputing the number into the deg function (only way it will work with ?arb? numbers. For inverse trig functions, divide the output by deg.",{"trigonometry","constant"},{"sin(180deg) = 0","cos(45deg) = sqrt(2)/2","cos(deg(45)) = sqrt(2)/2)","sin(deg(180p50)) = 0p50","acos(sqrt(2)/2))/deg = 45","atan(sqrt(3))/deg = 60"}),
    ...
    Page("Run","run","function","Runs the ?lambda? function `func` with the arguments provided. If not enough arguments are provided, zeroes are filled in. If you have a ?vector? of arguments, use the `apply` function. You can also use a ?string? in the first argument that represents a builtin function.",{"lambda","compute"},{"run(x=>x+2,4) = 6","run(_=>4) = 4","run((x,y)=>x+y, 4, 6) = 10","run(\"mul\",3,5) = 15"}),
    ...
    Page("To Lambda","tostring","function","Returns a constant ?lambda? type that returns `val`. For any input `x`, the return value is `_=>x`. However if `x` is a ?string?, it will return a lambda with that type of builtin function.",{"convert"},{"tolambda(45) = _=>45","tolambda(\"add\") = (a,b)=>a+b","tolambda(\"sqrt\") = x=>sqrt(x)"}),
