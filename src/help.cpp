...
std::vector<Page> Help::pages = {
    ...
    Page("Pi","pi","function","Constant that retuns the number pi. Pi is the ratio between the circumference ofa circle and it's diameter. Pi is used a lot in ?trigonometry?. Pi returns a double precision float, see `arb_pi` for a more accurate calculation.",{"constant"},{"pi = 3.141592653"},"https://en.wikipedia.org/wiki/Pi"),
    Page("Euler's number","e","function","Constant that retuns euler's number, which is the base of natural logarithms. `e` is used a lot in math past algebra. `e` returns a double precision float, see `arb_e` for a more accurate calculation.",{"constant"},{"e = 2.71828183"},"https://en.wikipedia.org/wiki/E_(mathematical_constant)"),
